...
date = 2024-01-01
description = "In our inaugural episode, we introduce the podcast, discuss what's coming up, and share our vision for the show."
...
season = 1
episode_type = "full"
itunes_subtitle = "The beginning of an amazing journey"
itunes_summary = "Join us as we kick off our podcast journey with an introduction to who we are, what we'll be covering, and why we're so excited to share this with you."
show_notes = """
## Links mentioned in this episode:

- [Our website](https://example.com)
- [Twitter](https://twitter.com/example)
- [Support us on Patreon](https://patreon.com/example)

## Topics covered:

- Introduction to the hosts
- Our podcast format and schedule
- Topics we'll be covering
- How to get in touch and submit questions
"""
+++
