...
Add the following configuration variables to your `config.toml` file in the `[extra]` section:
...
- `itunes_image` - Full URL to podcast cover art (1400x1400 to 3000x3000 pixels recommended)
